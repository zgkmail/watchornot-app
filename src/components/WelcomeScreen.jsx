...
const WelcomeScreen = ({ onStartOnboarding, onSkip, isDarkMode }) => {
    ...
    const WatchOrNotIcon = () => (
        <div className="flex justify-center mt-20 mb-8">
            <div className="relative w-[140px] h-[140px] rounded-full bg-gradient-to-br from-blue-500 to-purple-500 shadow-2xl shadow-blue-500/50 animate-bounce-slow flex items-center justify-center">
                {/* Camera Icon */}
    ...
    const Screen1 = () => (
        <div className="h-full flex flex-col justify-between py-safe">
            <div className="flex-1 flex flex-col">
                ...
                <div className="mx-6 mt-10 flex-1 flex items-center">
    ...
    const Screen2 = () => (
        <div className="h-full flex flex-col justify-between py-safe">
            <div className="flex-1 flex flex-col">
                ...
                <div className="mx-4 flex-1 flex items-start">
