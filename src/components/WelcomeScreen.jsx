    ...
    return (
        <>
            ...
            >
                ...
                {/* Swipeable container */}
                <div
                    className="h-full w-full overflow-hidden flex transition-transform duration-300 ease-out"
                    style={{
                        transform: `translateX(-${currentScreen * 100}vw)`
                    }}
                >
                    {/* Screen 1: Welcome & Introduction */}
                    <div className="w-screen h-full flex-shrink-0 flex flex-col justify-between safe-area-top safe-area-bottom">
                        {/* Debug indicator */}
